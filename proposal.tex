...
\setCJKfamilyfont{MyCJKkati}{楷体_GB2312.ttf} %楷体_GB2312，用于正文二级标题
...
\input{2_referenceSummary.tex}%
\clearpage

\input{3_researchContent}%
\clearpage

% \input{4_researchCondition.tex}%
% \clearpage

\input{5_schedule.tex}%
\clearpage
...
%导师评价，可以先签字后替换或s者利用电子签名
% \input{7_advisorComments.tex}%
% \clearpage

%插入导师评价
% \includepdf[pages=-]{导师评语.pdf}
% \clearpage
